...
public class Md5Util {
	...
	/**
	 * 
	 * @Title: calcMd5 @Description: md5У�� ���ļ�����+�ļ����ֹ�ͬ��� @param @param
	 * file @param @return @param @throws IOException @param @throws
	 * NoSuchAlgorithmException �趨�ļ� @return String �������� @throws
	 */
